...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = SPIx_SCK_Pin|SPIx_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, SPIx_SCK_Pin|SPIx_MISO_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = MOTOR4_RX_Pin|MOTOR4_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* UART4_TX Init */
    hdma_uart4_tx.Instance = DMA2_Stream6;
  ...
  */
    ...
    PE1     ------> UART8_TX
    */
    GPIO_InitStruct.Pin = LIDAR3_RX_Pin|LIDAR3_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|ESP32_TX_Pin|ESP32_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, MOTOR4_RX_Pin|MOTOR4_TX_Pin);
  ...
  else if(huart->Instance==UART5)
  {
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, LIDAR_RX_Pin|LIDAR_TX_Pin);
  ...
  else if(huart->Instance==UART7)
  {
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, LIDAR2_RX_Pin|LIDAR2_TX_Pin);
  ...
  else if(huart->Instance==UART8)
  {
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, LIDAR3_RX_Pin|LIDAR3_TX_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_0|GPIO_PIN_1|ESP32_TX_Pin|ESP32_RX_Pin);

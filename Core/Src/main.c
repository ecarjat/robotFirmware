...
static void MX_SDMMC1_SD_Init(void)
{
  ...
  {
    // No card inserted; skip init so boot can continue.
    return;
  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BL_LED_Pin|LCD_CS_Pin|LVCD_WS_RS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LeftHipUpperLimit_Pin LeftHipLowerLimit_Pin */
  GPIO_InitStruct.Pin = LeftHipUpperLimit_Pin|LeftHipLowerLimit_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RightHipUpperLimit_Pin MICROSD_SW_Pin RightHipLowerLimit_Pin */
  GPIO_InitStruct.Pin = RightHipUpperLimit_Pin|MICROSD_SW_Pin|RightHipLowerLimit_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
  ...
  HAL_NVIC_SetPriority(BMM150_INT1_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(BMM150_INT1_EXTI_IRQn);

  /* USER CODE BEGIN MX_GPIO_Init_2 */
  GPIO_InitStruct.Pin = BMI270_INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BMI270_INT1_GPIO_Port, &GPIO_InitStruct);
